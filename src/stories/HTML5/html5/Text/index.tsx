function Headings() {
  return (
    <article className="flow" id="text__headings">
      <header>
        <h2>Headings</h2>
      </header>
      <div>
...
function Paragraphs() {
  return (
    <article className="flow" id="text__paragraphs">
      <header>
        <h2>Paragraphs</h2>
      </header>
      <div>
...
function Blockquotes() {
  return (
    <article className="flow" id="text__blockquotes">
      <header>
        <h2>Blockquotes</h2>
      </header>
      <div>
...
function Lists() {
  return (
    <article className="flow" id="text__lists">
      <header>
        <h2>Lists</h2>
      </header>
      <div>
...
function Comments() {
  return (
    <article className="flow" id="text__comments">
      <header>
        <h2>HTML Comments</h2>
      </header>
      <div>
...
function Inline() {
  return (
    <article className="flow" id="text__inline">
      <header>
...
function Code() {
  return (
    <article className="flow" id="text__code">
      <header>
        <h2>Code</h2>
      </header>
      <div>
...
function Tables() {
  return (
    <article className="flow" id="text__tables">
      <header>
        <h2>Tabular data</h2>
      </header>
      <table>
...
function Hr() {
  return (
    <article className="flow" id="text__hr">
      <header>
...
function Address() {
  return (
    <article className="flow" id="text__address">
      <header>
        <h1>Address</h1>
      </header>
      <address>
...
function Details() {
  return (
    <article className="flow" id="text__details">
      <header>
