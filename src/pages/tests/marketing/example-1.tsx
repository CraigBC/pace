...
const pricing = {
  ...
  tiers: [
    ...
    },
    {
      ...
      description: "orem ipsum dolor est.",
...
const faqs = [
  {
    question: "What's the best thing about British Cycling?",
    answer:
    ...
    <div className="mx-auto mt-24 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden bg-neutral-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
        ...
        <div className="relative mx-auto max-w-2xl lg:mx-0">
          <img className="h-8 w-auto" src="/pace-ui-white.svg" alt="" />
          <figure>
            ...
            <figcaption className="mt-6 text-base text-white">
              <div className="font-semibold">Craig Edney</div>
              <div className="mt-1">Cyclist</div>
            </figcaption>
          </figure>
        </div>
      </div>
    ...
    <div className="mt-16 flex justify-center">
      <p className="relative rounded-full bg-neutral-50 px-4 py-1.5 text-sm leading-6 text-neutral-600 ring-1 ring-inset ring-neutral-900/5">
        <span className="hidden md:inline">
          "British Cycling supported me to become..."
        </span>
        <a href="#" className="font-semibold text-primary-600">
          <span className="absolute inset-0" aria-hidden="true" /> See the case
      ...
      <header>
        ...
        >
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img className="h-12 w-auto" src="/pace-ui-logo.png" alt="" />
          </a>
      ...
      <main>
        ...
        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-32 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-neutral-600">
            Choose an affordable membership that’s packed with the best features
      ...
      <footer className="bg-neutral-900" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <img className="h-7" src="/pace-ui-white.svg" alt="Company name" />
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {footerNavigation.navHeader1.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                ...
                <div className="mt-10 md:mt-0">
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {footerNavigation.navHeader2.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-sm leading-6 text-neutral-300 hover:text-white"
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {footerNavigation.navHeader3.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-sm leading-6 text-neutral-300 hover:text-white"
                ...
                <div className="mt-10 md:mt-0">
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {footerNavigation.navHeader4.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-sm leading-6 text-neutral-300 hover:text-white"
